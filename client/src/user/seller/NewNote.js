...
class Seller_newnote extends Component {
    constructor(props) {
        super(props);
        this.state = {
            content: "",
        ...
        this.getCurrentSeller = this.getCurrentSeller.bind(this);
    ...
    handleSubmit(event) {
        ...
        const noteRequest = {
            sellerNric: this.state.currentUser.nric,
